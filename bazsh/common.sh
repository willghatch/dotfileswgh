...
PATH=$DOTFILESWGH/dotlocal/commands:$WGHHOME/bin:$WGHHOME/lscripts:$WGHHOME/vscripts:$WGHHOME/wghsrv_scripts:$DOTFILESWGH/commands:$WGHHOME/.cabal/bin:$HROOT/bin:$HROOT/usr/bin:$HROOT/usr/local/bin:$WGHHOME/.local/bin:$PATH:/usr/bin:/bin:/usr/local/bin:/sbin:/usr/sbin:/usr/local/sbin
