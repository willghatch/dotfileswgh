...
globalkeys = awful.util.table.join(
    ...
    -- Launch Programs
    awful.key({ modkey, "Control" },    "Return",     function () awful.util.spawn("bashrun")  end),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "i",      function(c) awful.client.movetoscreen(c, awful.screen.getbycoord(mouse.coords().x, mouse.coords().y) -1) end) ,
