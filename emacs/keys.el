...
(define-key evil-normal-state-map "X" 'repeatable-evil-delete-backward-char)
...
(define-key evil-normal-state-map (kbd "DEL") 'repeatable-evil-backward-char)
...
(define-key evil-motion-state-map "b" 'repeatable-evil-backward-word-begin)
(define-key evil-motion-state-map "B" 'repeatable-evil-backward-WORD-begin)
(define-key evil-motion-state-map "E" 'repeatable-evil-forward-WORD-end)
(define-key evil-motion-state-map "f" 'repeatable-evil-find-char)
(define-key evil-motion-state-map "F" 'repeatable-evil-find-char-backward)
(define-key evil-motion-state-map "G" 'evil-goto-line)
(define-key evil-motion-state-map "h" 'repeat-motion-backward)
(define-key evil-motion-state-map "H" 'evil-window-top)
(define-key evil-motion-state-map "j" 'repeatable-evil-next-line)
(define-key evil-motion-state-map "k" 'repeatable-evil-previous-line)
(define-key evil-motion-state-map "l" 'repeat-motion-forward)
...
(define-key evil-motion-state-map "w" 'repeatable-evil-forward-word-begin)
(define-key evil-motion-state-map "W" 'repeatable-evil-forward-WORD-begin)
(define-key evil-motion-state-map "ge" 'repeatable-evil-backward-word-end)
(define-key evil-motion-state-map "gE" 'repeatable-evil-backward-WORD-end)
...
(define-key evil-motion-state-map "{" 'repeatable-evil-backward-paragraph)
(define-key evil-motion-state-map "}" 'repeatable-evil-forward-paragraph)
(define-key evil-motion-state-map "#" 'repeatable-evil-search-word-backward)
(define-key evil-motion-state-map "g#" 'repeatable-evil-search-unbounded-word-backward)
(define-key evil-motion-state-map "$" 'evil-end-of-line)
(define-key evil-motion-state-map "%" 'evil-jump-item)
(define-key evil-motion-state-map "`" 'evil-goto-mark)
(define-key evil-motion-state-map "'" 'evil-goto-mark-line)
(define-key evil-motion-state-map "(" 'repeatable-evil-backward-sentence)
(define-key evil-motion-state-map ")" 'repeatable-evil-forward-sentence)
(define-key evil-motion-state-map "]]" 'repeatable-evil-forward-section-begin)
(define-key evil-motion-state-map "][" 'repeatable-evil-forward-section-end)
(define-key evil-motion-state-map "[[" 'repeatable-evil-backward-section-begin)
(define-key evil-motion-state-map "[]" 'repeatable-evil-backward-section-end)
(define-key evil-motion-state-map "[(" 'repeatable-evil-previous-open-paren)
(define-key evil-motion-state-map "])" 'repeatable-evil-next-close-paren)
(define-key evil-motion-state-map "[{" 'repeatable-evil-previous-open-brace)
(define-key evil-motion-state-map "]}" 'repeatable-evil-next-close-brace)
(define-key evil-motion-state-map "*" 'repeatable-evil-search-word-forward)
(define-key evil-motion-state-map "g*" 'repeatable-evil-search-unbounded-word-forward)
(define-key evil-motion-state-map "," 'evil-repeat-find-char-reverse)
(define-key evil-motion-state-map "/" 'repeatable-evil-search-forward)
(define-key evil-motion-state-map ";" 'repeatable-evil-repeat-find-char)
(define-key evil-motion-state-map "?" 'repeatable-evil-search-backward)
...
(define-key evil-motion-state-map [left] 'repeatable-evil-backward-char)
(define-key evil-motion-state-map [right] 'repeatable-evil-forward-char)
(define-key evil-motion-state-map [up] 'repeatable-evil-previous-line)
(define-key evil-motion-state-map [down] 'repeatable-evil-next-line)
...
(define-key evil-motion-state-map "ee" 'repeatable-evil-forward-word-end)
(define-key evil-motion-state-map "oe" 'repeatable-evil-backward-word-end)
(define-key evil-motion-state-map "eE" 'repeatable-evil-forward-WORD-end)
(define-key evil-motion-state-map "oE" 'repeatable-evil-backward-WORD-end)
...
(define-key evil-motion-state-map "ec" 'repeatable-evil-forward-char)
(define-key evil-motion-state-map "oc" 'repeatable-evil-backward-char)
(define-key evil-motion-state-map "ea" 'repeatable-evil-forward-arg)
(define-key evil-motion-state-map "oa" 'repeatable-evil-backward-arg)
(define-key evil-motion-state-map "ew" 'repeatable-evil-forward-little-word-begin)
(define-key evil-motion-state-map "ow" 'repeatable-evil-backward-little-word-begin)
(define-key evil-motion-state-map "eW" 'repeatable-evil-forward-little-word-end)
(define-key evil-motion-state-map "oW" 'repeatable-evil-backward-little-word-end)
(define-key evil-motion-state-map "ed" 'repeatable-evil-next-close-paren)
(define-key evil-motion-state-map "od" 'repeatable-evil-previous-open-paren)
(define-key evil-motion-state-map "ed" 'repeatable-evil-next-close-brace)
(define-key evil-motion-state-map "od" 'repeatable-evil-previous-open-brace)
(define-key evil-motion-state-map "ep" 'repeatable-evil-forward-sentence-begin)
(define-key evil-motion-state-map "op" 'repeatable-evil-backward-sentence-begin)
(define-key evil-motion-state-map "eP" 'repeatable-evil-forward-paragraph)
(define-key evil-motion-state-map "oP" 'repeatable-evil-backward-paragraph)
(define-key evil-motion-state-map "es" 'repeatable-evil-forward-section-begin)
(define-key evil-motion-state-map "os" 'repeatable-evil-backward-section-begin)
(define-key evil-motion-state-map "eS" 'repeatable-evil-forward-section-end)
(define-key evil-motion-state-map "oS" 'repeatable-evil-backward-section-end)
(define-key evil-motion-state-map "eh" 'repeatable-evil-search-forward)
(define-key evil-motion-state-map "oh" 'repeatable-evil-search-backward)
(define-key evil-motion-state-map "et" 'repeatable-evil-find-char-to)
(define-key evil-motion-state-map "ot" 'repeatable-evil-find-char-to-backward)
(define-key evil-motion-state-map "ef" 'repeatable-evil-find-char)
(define-key evil-motion-state-map "of" 'repeatable-evil-find-char-backward)
(define-key evil-motion-state-map "em" 'repeatable-evil-repeat-find-char)
(define-key evil-motion-state-map "om" 'repeatable-evil-repeat-find-char-reverse)
(define-key evil-motion-state-map "en" 'evil-search-next)
(define-key evil-motion-state-map "on" 'evil-search-previous)
(define-key evil-motion-state-map "ol" 'repeatable-evil-goto-column)
...
(define-key evil-motion-state-map "eO" 'repeatable-forward-symbol)
(define-key evil-motion-state-map "oO" 'repeatable-backward-symbol)
(define-key evil-motion-state-map "ej" 'repeatable-evil-jump-forward)
(define-key evil-motion-state-map "oj" 'repeatable-evil-jump-backward)

(define-key evil-motion-state-map "f" 'repeat-motion-forward)
(define-key evil-motion-state-map "F" 'repeat-motion-backward)
