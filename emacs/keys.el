...
(myhydradef completer-map
            ...
            ("gc" (progn (require 'git-capf)
                           (cape-interactive 'wgh/git-commit-capf))
             "git-commit")
            ("gw" (progn (require 'git-capf)
                           (cape-interactive 'wgh/git-worktree-capf))
             "git-worktree")
            ("gs" (progn (require 'git-capf)
                           (cape-interactive 'wgh/git-submodule-capf))
             "git-submodule")
            ("gb" (progn (require 'git-capf)
                           (cape-interactive 'wgh/git-branch-capf))
             "git-branch")
            ("gf" (progn (require 'git-capf)
                           (cape-interactive 'wgh/git-file-capf))
             "git-file")
            ("C-g" 'ignore "quit")
            )
