...
(define-key evil-motion-state-map "h" 'repeatable-evil-backward-char)
...
(define-key evil-motion-state-map "l" 'repeatable-evil-forward-char)
...
(define-key evil-motion-state-map "es" 'repeatable-evil-forward-sentence)
(define-key evil-motion-state-map "os" 'repeatable-evil-backward-sentence)
...
(define-key evil-motion-state-map "ec" 'repeatable-evil-forward-section-begin)
(define-key evil-motion-state-map "oc" 'repeatable-evil-backward-section-begin)
(define-key evil-motion-state-map "eC" 'repeatable-evil-forward-section-end)
(define-key evil-motion-state-map "oC" 'repeatable-evil-backward-section-end)
