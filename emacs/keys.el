...
(mkmap "od" 'repeatable-motion-on-parens-down-sexp)
(mkmap "eg" 'repeatable-motion-on-parens-up-sexp-end)
(mkmap "og" 'repeatable-motion-on-parens-up-sexp)
(mkmap "eh" 'repeatable-motion-on-parens-forward-sexp)
(mkmap "oh" 'repeatable-motion-on-parens-backward-sexp)
(mkmap "em" 'repeatable-motion-on-parens-forward-sexp-end)
(mkmap "om" 'repeatable-motion-on-parens-backward-sexp-end)
