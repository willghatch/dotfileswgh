...
(defhydra command-select (:foreign-keys warn :exit nil) "Cmd:"
  ...
  ("j" (funcall (cs/add (cs/verb 'join))) "join" :exit t)
  ("J" (funcall (cs/add (cs/verb 'split))) "split" :exit t)
  ("o" (funcall (cs/add (cs/verb 'open))) "open" :exit t)
  ("t" (funcall (cs/add (cs/verb 'transpose))) "transpose" :exit t)
  ("s" (funcall (cs/add (cs/verb 'slurp))) "slurp" :exit t)
  ("b" (funcall (cs/add (cs/verb 'barf))) "barf" :exit t)
  ("u" (funcall (cs/add (cs/verb 'downcase))) "downcase" :exit t)
  ("U" (funcall (cs/add (cs/verb 'upcase))) "upcase" :exit t)
...
(defhydra object-select (:foreign-keys warn :exit nil) "Obj:"
  ...
  ("c" (funcall (cs/ae (cs/obj 'character))) "character" :exit nil)
