...
(ecmap "cc" (cs/add (cs/verb 'change)))
(evmap "cc" (cs/ae (cs/verb 'change)
                   (cs/obj 'region)))
(ecmap "cd" (cs/add (cs/verb 'delete)))
(evmap "cd" (cs/ae (cs/verb 'delete)
                   (cs/obj 'region)))
(ecmap "cy" (cs/add (cs/verb 'copy)))
(evmap "cy" (cs/ae (cs/verb 'copy)
                   (cs/obj 'region)))
(ecmap "cj" (cs/add (cs/verb 'join)))
(ecmap "cJ" (cs/add (cs/verb 'split)))
(ecmap "co" (cs/add (cs/verb 'open)))
(ecmap "ct" (cs/add (cs/verb 'transpose)))
(ecmap "cs" (cs/add (cs/verb 'slurp)))
(ecmap "cb" (cs/add (cs/verb 'barf)))
(ecmap "cu" (cs/add (cs/verb 'downcase)))
(ecmap "cU" (cs/add (cs/verb 'upcase)))

;; Modifiers for command-sentence
(emmap "he" (cs/add (cs/mod 'location-within 'end)))
(emmap "hI" (cs/add (cs/mod 'tree-inner t)))
(emmap "ht" (cs/add (cs/mod 'tree-traversal 'inorder)))
(emmap "hu" (cs/add (cs/mod 'tree-vertical 'up)))
(emmap "hd" (cs/add (cs/mod 'tree-vertical 'down)))
;; TODO - implement these modifiers
(emmap "hr" 'TODO_register-select)
(emmap "hi" (cs/add (cs/mod 'idempotent 'idempotent)))
(emmap "hl" (cs/add (cs/mod 'current-line-only 'current-line-only)))
(emmap "hs" (cs/add (cs/mod 'surrounding-space 'surrounding-space)))
...
(emmap "ew" (cs/ae (cs/mod 'direction 'forward)
                   (cs/obj 'vi-like-word)))
(emmap "ow" (cs/ae (cs/mod 'direction 'backward)
                   (cs/obj 'vi-like-word)))
...
(emmap "oW" (cs/ae (cs/mod 'direction 'backward)
                   (cs/obj 'word)))
(eramap "W" 'wgh/expand-region-to-word)
(emmap "eb" (cs/ae (cs/mod 'direction 'forward)
                   (cs/obj 'sptw)))
(emmap "ob" (cs/ae (cs/mod 'direction 'backward)
                   (cs/obj 'sptw)))
...
(emmap "os" (cs/ae (cs/mod 'direction 'backward)
                   (cs/obj 'sptw)))
(eramap "s" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region t)
                   (cs/obj 'sptw)))
(erimap "s" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region 'inner)
                   (cs/obj 'sptw)))
...
(erimap "»" (cs/ae (cs/mod 'direction nil)
                   ...
                   (cs/mod 'delimiter "«")
                   (cs/obj 'sptw)))
(emmap "ey" (cs/ae (cs/mod 'direction 'forward)
                   (cs/obj 'symbol)))
(emmap "oy" (cs/ae (cs/mod 'direction 'forward)
                   (cs/obj 'symbol)))
(eramap "y" 'wgh/expand-region-to-symbol)
...
(emmap "oo" (cs/ae (cs/mod 'direction 'backward)
                   (cs/obj 'outline)))
(eramap "o" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region t)
                   (cs/obj 'outline)))
(erimap "o" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region 'inner)
                   (cs/obj 'outline)))
...
(emmap "oi" (cs/ae (cs/mod 'direction 'backward)
                   (cs/obj 'indent-tree)))
(eramap "i" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region t)
                   (cs/obj 'indent-tree)))
(erimap "i" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region 'inner)
                   (cs/obj 'indent-tree)))
(emmap "ex" (cs/ae (cs/mod 'direction 'forward)
                   (cs/obj 'xml)))
(emmap "ox" (cs/ae (cs/mod 'direction 'backward)
                   (cs/obj 'xml)))
(eramap "x" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region t)
                   (cs/obj 'xml)))
(erimap "x" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region 'inner)
                   (cs/obj 'xml)))
...
(emmap "el" (cs/ae (cs/mod 'direction 'forward)
                   (cs/obj 'line)))
(emmap "ol" (cs/ae (cs/mod 'direction 'backward)
                   (cs/obj 'line)))
