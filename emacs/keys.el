...
(define-key evil-normal-state-map "X" 'repeatable-motion/evil-delete-backward-char)
...
(define-key evil-motion-state-map "eh" 'repeatable-motion/evil-search-forward)
(define-key evil-motion-state-map "oh" 'repeatable-motion/evil-search-backward)
...
(define-key evil-motion-state-map "em" 'repeatable-motion/evil-repeat-find-char)
