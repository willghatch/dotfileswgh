...
(define-key evil-normal-state-map (kbd "DEL") 'repeatable-motion-evil-backward-char)
...
(define-key evil-motion-state-map "b" 'repeatable-motion-evil-backward-word-begin)
(define-key evil-motion-state-map "B" 'repeatable-motion-evil-backward-WORD-begin)
(define-key evil-motion-state-map "E" 'repeatable-motion-evil-forward-WORD-end)
...
(define-key evil-motion-state-map "w" 'repeatable-motion-evil-forward-word-begin)
(define-key evil-motion-state-map "W" 'repeatable-motion-evil-forward-WORD-begin)
(define-key evil-motion-state-map "ge" 'repeatable-motion-evil-backward-word-end)
(define-key evil-motion-state-map "gE" 'repeatable-motion-evil-backward-WORD-end)
...
(define-key evil-motion-state-map "{" 'repeatable-motion-evil-backward-paragraph)
(define-key evil-motion-state-map "}" 'repeatable-motion-evil-forward-paragraph)
(define-key evil-motion-state-map "#" 'repeatable-motion-evil-search-word-backward)
(define-key evil-motion-state-map "g#" 'repeatable-motion-evil-search-unbounded-word-backward)
(define-key evil-motion-state-map "$" 'evil-end-of-line)
(define-key evil-motion-state-map "%" 'evil-jump-item)
(define-key evil-motion-state-map "`" 'evil-goto-mark)
(define-key evil-motion-state-map "'" 'evil-goto-mark-line)
(define-key evil-motion-state-map "(" 'repeatable-motion-evil-backward-sentence)
(define-key evil-motion-state-map ")" 'repeatable-motion-evil-forward-sentence)
(define-key evil-motion-state-map "]]" 'repeatable-motion-evil-forward-section-begin)
(define-key evil-motion-state-map "][" 'repeatable-motion-evil-forward-section-end)
(define-key evil-motion-state-map "[[" 'repeatable-motion-evil-backward-section-begin)
(define-key evil-motion-state-map "[]" 'repeatable-motion-evil-backward-section-end)
(define-key evil-motion-state-map "[(" 'repeatable-motion-evil-previous-open-paren)
(define-key evil-motion-state-map "])" 'repeatable-motion-evil-next-close-paren)
(define-key evil-motion-state-map "[{" 'repeatable-motion-evil-previous-open-brace)
(define-key evil-motion-state-map "]}" 'repeatable-motion-evil-next-close-brace)
(define-key evil-motion-state-map "*" 'repeatable-motion-evil-search-word-forward)
(define-key evil-motion-state-map "g*" 'repeatable-motion-evil-search-unbounded-word-forward)
(define-key evil-motion-state-map "," 'evil-repeat-find-char-reverse)
(define-key evil-motion-state-map "/" 'repeatable-motion-evil-search-forward)
(define-key evil-motion-state-map ";" 'repeatable-motion-evil-repeat-find-char)
(define-key evil-motion-state-map "?" 'repeatable-motion-evil-search-backward)
...
(define-key evil-motion-state-map [left] 'repeatable-motion-evil-backward-char)
(define-key evil-motion-state-map [right] 'repeatable-motion-evil-forward-char)
(define-key evil-motion-state-map [up] 'repeatable-motion-evil-previous-line)
(define-key evil-motion-state-map [down] 'repeatable-motion-evil-next-line)
...
(define-key evil-motion-state-map "ee" 'repeatable-motion-evil-forward-word-end)
(define-key evil-motion-state-map "oe" 'repeatable-motion-evil-backward-word-end)
(define-key evil-motion-state-map "eE" 'repeatable-motion-evil-forward-WORD-end)
(define-key evil-motion-state-map "oE" 'repeatable-motion-evil-backward-WORD-end)
...
(define-key evil-motion-state-map "ec" 'repeatable-motion-evil-forward-char)
(define-key evil-motion-state-map "oc" 'repeatable-motion-evil-backward-char)
;(define-key evil-motion-state-map "ed" 'repeatable-motion-evil-next-close-paren)
;(define-key evil-motion-state-map "od" 'repeatable-motion-evil-previous-open-paren)
;(define-key evil-motion-state-map "ed" 'repeatable-motion-evil-next-close-brace)
;(define-key evil-motion-state-map "od" 'repeatable-motion-evil-previous-open-brace)
(define-key evil-motion-state-map "ed" 'repeatable-motion-on-parens-down-sexp)
(define-key evil-motion-state-map "od" 'repeatable-motion-on-parens-up-sexp)
(define-key evil-motion-state-map "eD" 'repeatable-motion-on-parens-down-sexp-end)
(define-key evil-motion-state-map "oD" 'repeatable-motion-on-parens-up-sexp-end)
(define-key evil-motion-state-map "eh" 'repeatable-motion-on-parens-forward-sexp)
(define-key evil-motion-state-map "oh" 'repeatable-motion-on-parens-backward-sexp)
(define-key evil-motion-state-map "eH" 'repeatable-motion-on-parens-forward-sexp-end)
(define-key evil-motion-state-map "oH" 'repeatable-motion-on-parens-backward-sexp-end)
(define-key evil-motion-state-map "en" 'repeatable-motion-on-parens-forward-sexp-in-supersexp)
(define-key evil-motion-state-map "on" 'repeatable-motion-on-parens-backward-sexp-in-supersexp)
(define-key evil-motion-state-map "ea" 'repeatable-motion-evil-forward-arg)
(define-key evil-motion-state-map "oa" 'repeatable-motion-evil-backward-arg)
(define-key evil-motion-state-map "ew" 'repeatable-motion-evil-forward-little-word-begin)
(define-key evil-motion-state-map "ow" 'repeatable-motion-evil-backward-little-word-begin)
(define-key evil-motion-state-map "eW" 'repeatable-motion-evil-forward-little-word-end)
(define-key evil-motion-state-map "oW" 'repeatable-motion-evil-backward-little-word-end)
(define-key evil-motion-state-map "ep" 'repeatable-motion-evil-forward-sentence-begin)
(define-key evil-motion-state-map "op" 'repeatable-motion-evil-backward-sentence-begin)
(define-key evil-motion-state-map "eP" 'repeatable-motion-evil-forward-paragraph)
(define-key evil-motion-state-map "oP" 'repeatable-motion-evil-backward-paragraph)
(define-key evil-motion-state-map "es" 'repeatable-motion-evil-forward-section-begin)
(define-key evil-motion-state-map "os" 'repeatable-motion-evil-backward-section-begin)
(define-key evil-motion-state-map "eS" 'repeatable-motion-evil-forward-section-end)
(define-key evil-motion-state-map "oS" 'repeatable-motion-evil-backward-section-end)
(define-key evil-motion-state-map "et" 'repeatable-motion-evil-find-char-to)
(define-key evil-motion-state-map "ot" 'repeatable-motion-evil-find-char-to-backward)
(define-key evil-motion-state-map "ef" 'repeatable-motion-evil-find-char)
(define-key evil-motion-state-map "of" 'repeatable-motion-evil-find-char-backward)
...
(define-key evil-motion-state-map "eO" 'repeatable-motion-forward-symbol)
(define-key evil-motion-state-map "oO" 'repeatable-motion-backward-symbol)
(define-key evil-motion-state-map "ej" 'repeatable-motion-evil-jump-forward)
(define-key evil-motion-state-map "oj" 'repeatable-motion-evil-jump-backward)
;; eu/ou for destructive subcommands!
(define-key evil-motion-state-map "eus" 'on-parens-forward-slurp)
(define-key evil-motion-state-map "ous" 'on-parens-backward-slurp)
(define-key evil-motion-state-map "eub" 'on-parens-forward-barf)
(define-key evil-motion-state-map "oub" 'on-parens-backward-barf)
(define-key evil-motion-state-map "euj" 'on-parens-join-neighbor-sexp)
(define-key evil-motion-state-map "ouj" 'on-parens-split-supersexp)
;; this one doesn't really belong...
(define-key evil-motion-state-map "eup" 'on-parens-splice)
(define-key evil-motion-state-map "oup" 'on-parens-splice)

(define-key evil-motion-state-map "f" 'repeatable-motion-forward)
(define-key evil-motion-state-map "F" 'repeatable-motion-backward)
