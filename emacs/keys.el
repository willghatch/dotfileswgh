...
(defun wgh/expand-region-to-fill-lines (&optional include-final-newline)
  ...
  (let ((point-first (< (point) (mark)))
    ...
    (exchange-point-and-mark)))
(evmap "al" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region t)
                   (cs/obj 'line)))
(evmap "il" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region 'inner)
                   (cs/obj 'line)))
(evmap "ab" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region t)
                   (cs/obj 'sptw)))
(evmap "ib" (cs/ae (cs/mod 'direction nil)
                   (cs/mod 'expand-region 'inner)
                   (cs/obj 'sptw)))
(evmap "a\"" (cs/ae (cs/mod 'direction nil)
                    (cs/mod 'expand-region t)
                    (cs/mod 'delimiter "\"")
                    (cs/obj 'sptw)))
(evmap "i\"" (cs/ae (cs/mod 'direction nil)
                    (cs/mod 'expand-region 'inner)
                    (cs/mod 'delimiter "\"")
                    (cs/obj 'sptw)))
(evmap "a)" (cs/ae (cs/mod 'direction nil)
...
(emmap "ec" (cs/ae (cs/mod 'direction 'forward)
                   (cs/obj 'character)))
(emmap "oc" (cs/ae (cs/mod 'direction 'forward)
                   (cs/obj 'character)))
