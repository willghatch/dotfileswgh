...
(custom-theme-set-faces
 ...
 '(flycheck-warning ((((background dark)) (:inherit error))))
 '(flymake-error ((((background dark light)) (:inherit warning))))
 '(flymake-note ((((background dark light)) (:inherit warning))))
 ...
 '(lsp-lens-face ((((background dark)) (:inherit font-lock-comment-face :background "#220f34"))
                  (((background light)) (:inherit font-lock-comment-face :background "#c8adfb"))))
