...
(custom-theme-set-faces
 ...
 '(diff-added ((((background dark)) (:background "#001000"))))
 '(diff-refine-added ((((background dark)) (:background "#001505"))))
 '(diff-changed ((((background dark)) (:background "#151500"))))
 '(diff-refine-changed ((((background dark)) (:background "#202000"))))
 ...
 '(diff-refine-removed ((((background dark)) (:background "#200000"))))
 '(error ((((background dark)) (:underline t :background "#400015"))
          (((background light)) (:underline t :background "#ff9f9f"))))
 '(estate-visual-modifier-expanded-region-face
   ((default (:inherit region))
    (((background dark)) (:background "#003067" :foreground "#ff30ff"))
    (((background light)) (:background "#dafaff" :foreground "#5f3000"))))
 ...
 '(region ((((background dark)) (:background "#000097" :foreground "#ff00ff"))
           (((background light)) (:background "#dadaff" :foreground "#5f3000"))))
