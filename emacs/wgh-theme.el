...
(custom-theme-set-faces
 ...
 '(markchars-heavy ((t (:foreground "#ffffff"))))
 '(markchars-light ((t (:foreground "#9f9f9f"))))
 '(markchars-white ((t (:foreground "#ffffff"))))
 ...
 '(outline-4 ((t (:foreground "#e0209f"))))
 '(outline-5 ((t (:foreground "#c70057"))))
 '(outline-6 ((t (:foreground "#c11019"))))
 '(outline-7 ((t (:foreground "#a01003"))))
 '(outline-8 ((t (:foreground "#904000"))))
 ...
 '(smerge-mine ((t (:background "#200000"))))
 '(smerge-other ((t (:background "#002000"))))
 '(smerge-refined-added ((t (:background "#103010"))))
 '(smerge-refined-removed ((t (:background "#301010"))))
