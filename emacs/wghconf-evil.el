...
(define-key evil-window-map "ic" 'kill-buffer)
(define-key evil-window-map "iC" 'evil-quit-all)
(define-key evil-window-map "iac" 'evil-quit-all)
(define-key evil-window-map "is" 'save-buffer)
(define-key evil-window-map "iS" 'evil-write-all)
...
(define-key evil-motion-state-map "gee" 'evil-backward-word-end)
(define-key evil-motion-state-map "geE" 'evil-backward-word-end)
(define-key evil-motion-state-map "gew" 'evil-forward-little-word-begin)
(define-key evil-motion-state-map "geb" 'evil-forward-little-word-begin)
(define-key evil-motion-state-map "geW" 'evil-forward-little-word-end)
(define-key evil-motion-state-map "geB" 'evil-forward-little-word-end)
(define-key evil-motion-state-map "gE" 'evil-backward-WORD-end)
(define-key evil-motion-state-map "gg" 'evil-goto-first-line)
(define-key evil-motion-state-map "gj" 'evil-next-visual-line)
(define-key evil-motion-state-map "gk" 'evil-previous-visual-line)
