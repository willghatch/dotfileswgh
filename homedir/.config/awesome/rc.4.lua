...
--              {description = "jump to urgent client", group = "client"}),
    ...
    awful.key({ }, "XF86AudioPause", mkspawn({"vlaunch", "musicpauseall"}),
              {description = "media pause", group = "launcher"}),
    awful.key({ }, "XF86AudioStop", mkspawn({"vlaunch", "musicpauseall"}),
    ...
    awful.key({ hypkey, supkey }, "m", mkNonRep(mkspawn({"mpcc", "toggle"}, {description = "", group = "launcher"}))),
    awful.key({ hypkey, supkey }, "t", mkNonRep(mkspawn({"vlaunch", "musictoggle"}, {description = "", group = "launcher"}))),
    awful.key({ hypkey, supkey }, "s", mkNonRep(mkspawn({"vlaunch", "musicpauseall"}, {description = "", group = "launcher"}))),
    ...
    awful.key({ hypkey, supkey, "Control" }, "n", mkNonRep(mkspawn({"vlaunch", "media_next_source"}, {description = "", group = "launcher"}))),
    awful.key({ hypkey, supkey, "Control" }, "p", mkNonRep(mkspawn({"vlaunch", "media_next_source"}, {description = "", group = "launcher"}))),
