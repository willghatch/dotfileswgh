...
# I want to copy over the zsh completion as well, but of course it depends on the name `rg` in various ways.
...
# TODO - try the `substitute` script available in the nixos builder stdenv: https://nixos.org/manual/nixpkgs/stable/#fun-substitute
