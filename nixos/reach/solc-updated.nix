...
let
  ...
  solc = gccStdenv.mkDerivation rec {
    ...
    src = fetchzip {
      ...
      sha256 = "1li7qq8g68slk7ygx3sk4av2r2ppd8il5fn3la5nvawcrpsqy6qf";
      # hash for version 0.8.17
      #sha256 = "0ZGDZvk+akO94aJZgktVErbWaU3+aKwRD283Mn9XrVE=";
    };
    ...
    cmakeFlags = [
      # TODO - solc version 0.8.11 wants EXACTLY z3 v4.8.13, but my current pin uses v4.8.14.  I think that should be fine?  Anyway, let's add this Z3 strict version check off to get things rolling for now.
